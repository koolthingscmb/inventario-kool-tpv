-- Migration: recreate tickets table with FK(dto_aplicado_id) -> descuentos(id) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS tickets_new (
    ...
    FOREIGN KEY(dto_aplicado_id) REFERENCES descuentos(id) ON DELETE CASCADE
);
...
-- Recreate index on dto_aplicado_id
CREATE INDEX IF NOT EXISTS idx_tickets_dto_aplicado_id ON tickets(dto_aplicado_id);
