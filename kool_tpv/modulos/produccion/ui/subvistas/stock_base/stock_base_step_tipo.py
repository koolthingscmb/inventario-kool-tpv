"""Paso 2: Selección de tipo (Camiseta, Taza, etc.) con chips."""
...
class StockBaseStepTipo(KeyboardNavigableMixin):
    """Subvista para seleccionar el tipo con chips.

    Args:
        parent: Widget padre.
        db: Instancia de Database.
        menu_id: ID del menú seleccionado.
