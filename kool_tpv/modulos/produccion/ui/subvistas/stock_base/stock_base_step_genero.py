"""Paso 3: Selección de género (Hombre, Mujer, Niño...) con chips."""
...
class StockBaseStepGenero(KeyboardNavigableMixin):
    """Subvista para seleccionar género con chips.
    ...
    def _on_siguiente(self):
        if self.genero_seleccionado and self.on_siguiente:
            self.on_siguiente(self.genero_seleccionado)
